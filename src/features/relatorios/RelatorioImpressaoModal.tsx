...
import { RelatorioImpressaoConteudo } from './RelatorioImpressaoConteudo'
import type { RelatorioImpressaoTipo } from './relatorioTipos'

type RelatorioImpressaoModalProps = {
  aberto: boolean
  aoFechar: () => void
 ...
 * O bloco #impressao-relatorio-root NÃO pode estar dentro de um ancestral .no-print,
...
export function RelatorioImpressaoModal({
  aberto,
  aoFechar,
  tipo,
  tituloDocumento,
